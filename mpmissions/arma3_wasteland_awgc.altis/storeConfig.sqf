...
[
	...
	["Beretta M9 9MM", "rhsusf_weap_m9", 250]
];
...
[
	...
	["AS Val w/ Rail", "rhs_weap_asval_npz", 3000],
	["AK-74", "rhs_weap_ak74", 2500],
	["AK-74m", "rhs_weap_ak74m", 2500],
	["AK-74 w/ Rail", "rhs_weap_ak74m_npz", 3500],
	["AK-74m Desert", "rhs_weap_ak74m_desert", 2500],
	["AK-74m Desert w/ Rail", "rhs_weap_ak74m_desert_npz", 3500],
	["H&K 416", "rhs_weap_hk416d10", 3500],	
	["H&K 416 w/ M320", "rhs_weap_hk416d10_m320", 5500],	
	["H&K G36 Compact", "rhs_weap_g36c", 4500],	
	...
	["M4A1 Desert w/ Rail", "rhs_weap_m4a1_blockII_d", 3000],		// RHS
	["M4A1 WoodLand w/ Rail", "rhs_weap_m4a1_blockII_wd", 3000],		// RHS
	["M16A4", "rhs_weap_m16a4_pmag", 2500],
	["RHS M4A1 Rail", "rhs_weap_m4a1_blockII_bk", 3000],		// RHS	
	
	// RHS Marksman
	["VSS Vintorez", "rhs_weap_vss", 5500],
	...
	// RHS Sniper Rifles
	["M76 Zastava", "rhs_weap_m76", 5000],		// RHS
	["SVD Dragunov", "rhs_weap_svdp", 5500],		// RHS
	["SVD Dragunov w/ Rail", "rhs_weap_svdp_npz", 5500],		// RHS
	["MK 11", "rhs_weap_sr25", 5500],		// RHS
	["MK 11 Desert", "rhs_weap_sr25_d", 5500],		// RHS
	["MK 11 WoodLand", "rhs_weap_sr25_wd", 5500],		// RHS
	["M24 Semi-Arid", "rhs_weap_m24sws", 5500],		// RHS
	["M24 Black", "rhs_weap_m24sws_blk", 5500],		// RHS
	["M40 Dessert", "rhs_weap_m40a5_d", 6000],		// RHS
	["M40 Woodland", "rhs_weap_m40a5_wd", 6000],		// RHS
	["M24 Ghillie", "rhs_weap_m24sws_ghillie", 6500],		// RHS
	["M2010 ESR Dessert", "rhs_weap_XM2010_d", 7500],		// RHS
	["M2010 ESR Semi-Arid", "rhs_weap_XM2010_sa", 7500],	
	["RHS M107", "rhs_weap_M107", 10000],		// RHS
	["M82 Barrett", "rhs_weap_m82a1", 10000],		// RHS
...
[
	...
	// RHS Launchers
	["RPG-7", "rhs_weap_rpg7", 30000],		// RHS
	["9K38 Igla AA", "rhs_weap_igla", 60000],		// RHS
	["FIM-92 Stinger AA", "rhs_weap_fim92", 60000],		// RHS
	["MAAWS M3", "rhs_weap_maaws", 40000],		// RHS
	...
	["FGM-148 Javelin", "rhs_weap_fgm148", 60000]		// RHS
];
...
[
	...
	["9MM FMJ 17Rnd", "rhsusf_mag_17Rnd_9x19_FMJ", 20],
	["9MM JHP 17Rnd", "rhsusf_mag_17Rnd_9x19_JHP", 20],
	["9MM JHP 15Rnd", "rhsusf_mag_15Rnd_9x19_JHP", 20],
	["9MM FMJ 15Rnd", "rhsusf_mag_15Rnd_9x19_FMJ", 20],
	[".45 ACP MHP 7Rnd", "rhsusf_mag_7x45acp_MHP", 20],
	...
	["7.62x39 30Rnd Mag", "rhs_30Rnd_545x39_AK", 20],		// RHS
	...
	["7.62x51mm 10Rnd Mag", "rhsusf_10Rnd_762x51_m118_special_Mag", 100],		// RHS
	...
	["7.62x54 10Rnd", "rhs_10Rnd_762x54mmR_7N1", 20],		// RHS
	["7.62x54 5Rnd", "rhsgref_5Rnd_762x54_m38", 10],		// RHS
	["7.92x57 10Rnd", "rhsgref_10Rnd_792x57_m76", 20],		// RHS
	...
	["RPG AP Frag", "rhs_rpg7_OG7V_mag", 3500],		// RHS
	["RPG AT AP AirBurst", "rhs_rpg7_type69_airburst_mag", 3500],		// RHS
	["RPG AT", "rhs_rpg7_PG7V_mag", 3500],		// RHS
	["RPG AT", "rhs_rpg7_PG7VL_mag", 4000],		// RHS
	["RPG AT Thermobaric", "rhs_rpg7_TBG7V_mag", 4500],		// RHS
	["RPG AT Penetrating", "rhs_rpg7_PG7VR_mag", 4500],		// RHS
	["MAAWS M3 HEDP", "rhs_mag_maaws_HEDP", 2500],		// RHS
	["MAAWS M3 HE", "rhs_mag_maaws_HE", 2500],		// RHS
	["MAAWS M3 HEAT", "rhs_mag_maaws_HEAT", 2500],		// RHS
	["Igla AA Rocket", "rhs_mag_9k38_rocket", 3500],		// RHS
	["Stinger AA Rocket", "rhs_fim92_mag", 3500],		// RHS
	...
	["M397 HET", "rhs_mag_M397_HET", 500],		// RHS
	["M433 HEDP", "rhs_mag_M433_HEDP", 500],		// RHS
...
[
	...
	//RHS Suppressors
	["SR-15 Suppressor Black", "rhsusf_acc_SR25S", 2000, "item"],		// RHS
	["SR-15 Suppressor Desert", "rhsusf_acc_SR25S_d", 2000, "item"],		// RHS
	["SR-15 Suppressor Woodland", "rhsusf_acc_SR25S_wd", 2000, "item"],		// RHS
	["ESR Suppressor Desert", "rhsusf_acc_M2010S_d", 2000, "item"],		// RHS
	["ESR Suppressor Sand", "rhsusf_acc_M2010S_sa", 2000, "item"],		// RHS
	["LMG Suppressor", "rhsusf_acc_ARDEC_M240", 2000, "item"],		// RHS
	["AK PBS-1 Suppressor", "rhs_acc_pbs1", 2000, "item"],		// RHS
	...
	["Harris BiPod", "rhs_acc_harris_swivel", 100, "item"],
	...
	["Cobra Red Dot", "rhs_acc_ekp1", 50, "item"],		// RHS
	["Cobra Reflex Sight", "rhs_acc_ekp8_02", 50, "item"],		// RHS
	["PK-A Red Dot", "rhs_acc_pkas", 50, "item"],		// RHS
	["PGO-7 V1 Launcher Scope", "rhs_acc_pgo7v", 50, "item"],		// RHS
	["PGO-7 V2 Launcher Scope", "rhs_acc_pgo7v2", 50, "item"],		// RHS
	["PGO-7 V3 Launcher Scope", "rhs_acc_pgo7v3", 50, "item"],		// RHS
	["1P29 5.45x39", "rhs_acc_1p29", 50, "item"],		// RHS
	["Obzor 1P63 TCS", "rhs_acc_1p63", 50, "item"],		// RHS
	["Kashtan 1P78 5.45x39", "rhs_acc_1p78", 50, "item"],		// RHS
	["1PN93 1st Gen", "rhs_acc_1pn93_1", 50, "item"],		// RHS
	["1PN93 2nd Gen", "rhs_acc_1pn93_2", 50, "item"],		// RHS
	["NIT-A", "rhs_acc_nita", 50, "item"],		// RHS
	["1P87", "rhs_acc_1p87", 75, "item"],		// RHS
	["Aimpoint Micro T1", "rhsusf_acc_T1_low", 50, "item"],		// RHS
	["Trijicon RM05", "rhsusf_acc_rm05", 50, "item"],		// RHS
	["eoTech", "rhsusf_acc_eotech", 75, "item"],		// RHS
	["eoTech XPS", "rhsusf_acc_eotech_xps3", 75, "item"],		// RHS
	["eoTech 552", "rhsusf_acc_eotech_552", 75, "item"],		// RHS
	["Aimpoint Comp M4", "rhsusf_acc_compm4", 75, "item"],		// RHS
	["Elcan Specter 1x-4x", "rhsusf_acc_spectedr", 75, "item"],		// RHS
	["ACOG", "rhsusf_acc_ACOG_USMC", 100, "item"],		// RHS
	["ACOG", "rhsusf_acc_acog", 100, "item"],		// RHS
	["ACOG Desert", "rhsusf_acc_acog_d", 100, "item"],		// RHS
	["ACOG MDO", "rhsusf_acc_acog_mdo", 150, "item"],		// RHS
	["MICRO G33 T1", "rhsusf_acc_g33_t1", 150, "item"],		// RHS
	...
	["Rakurs 1P76 1x20", "rhs_acc_rakurspm", 150, "item"],		// RHS
	["DMS", "optic_DMS", 1750, "item"],			// A3 Vanilla
	["DMS (G Hex)", "optic_DMS_ghex_F", 1750, "item", "noDLC"],		// A3 Vanilla
	["PSO-1 M2", "rhs_acc_pso1m2", 1750, "item"],		// RHS
	["PSO-1 M21", "rhs_acc_pso1m21", 2000, "item"],		// RHS
	...
	["DH5-20x56", "rhs_acc_dh520x56", 2500, "item"],		// RHS
	...
	["M135 MUNS NVS FLIR", "rhsusf_acc_anpvs27", 7000, "item"],		// RHS
	...
	["Insight LWTS Thermal 640x480 Thermal", "rhsusf_acc_anpas13gv1", 25000, "item"]		// RHS
];
...
[
	...
	["ACH Green", "rhsusf_ach_bare", 50, "hat"],		// RHS
	["ACH M-81", "rhsusf_ach_helmet_M81", 50, "hat"],		// RHS
	["ACH Tan", "rhsusf_ach_bare_tan_ess", 50, "hat"],		// RHS
	["ACH UCP", "rhsusf_ach_helmet_ucp", 50, "hat"],		// RHS
	["ACH OCP", "rhsusf_ach_helmet_ocp", 50, "hat"],		// RHS
	["SpecOps Black", "rhsusf_opscore_bk", 50, "hat"],		// RHS
	["SpecOps MC", "rhsusf_opscore_mc_cover_pelt", 50, "hat"],		// RHS
	["SpecOps Ranger", "rhsusf_opscore_rg_cover", 50, "hat"],		// RHS
	["SpecOps ProTech", "rhsusf_protech_helmet_ess", 50, "hat"],		// RHS
	["MICH", "rhsusf_mich_bare", 50, "hat"],		// RHS
	["MICH NVG Support", "rhsusf_mich_bare_norotos", 50, "hat"],		// RHS
	["MICH Semi-Arid", "rhsusf_mich_bare_semi", 50, "hat"],		// RHS
	["MICH ARC Semi-Arid", "rhsusf_mich_bare_norotos_arc_semi", 50, "hat"],		// RHS
	["MICH TAN", "rhsusf_mich_bare_tan", 50, "hat"],		// RHS
	["MARPAT Desert", "rhsusf_mich_helmet_marpatd_headset", 50, "hat"],		// RHS
	["MARPAT Woodland", "rhsusf_mich_helmet_marpatwd_headset", 50, "hat"],		// RHS
	
	// RHS Helmets Red
	["SSH-68", "rhs_ssh68", 50, "hat"],		// RHS
	["CH Green", "rhs_6b27m_green_ess_bala", 50, "hat"],		// RHS
	["CH Jungle", "rhs_6b26_ess", 50, "hat"],		// RHS
	["CH Green ESS", "rhs_6b26_ess_green", 50, "hat"],		// RHS
	["Altyn", "rhs_altyn_novisor_ess_bala", 50, "hat"],		// RHS
	["Altyn Visor", "rhs_altyn_visordown", 50, "hat"],		// RHS
	
	// RHS Helmets Brown (SAF)
	["M59", "rhssaf_helmet_m59_85_nocamo", 50, "hat"],		// RHS
	["M59 Oakleaf", "rhssaf_helmet_m59_85_oakleaf", 50, "hat"],		// RHS
	["M97 MD2 Camo", "rhssaf_helmet_m97_md2camo", 50, "hat"],		// RHS
	["M97 Black", "rhssaf_helmet_m97_black_nocamo_black_ess_bare", 50, "hat"],		// RHS
	["M97 DIGI", "rhssaf_helmet_m97_digital", 50, "hat"],		// RHS
	["M97 Oakleaf", "rhssaf_helmet_m97_oakleaf_black_ess_bare", 50, "hat"],		// RHS
	["M97 OD", "rhssaf_helmet_m97_olive_nocamo_black_ess_bare", 50, "hat"],		// RHS
	["M97 Woodland", "rhssaf_helmet_m97_woodland_black_ess_bare", 50, "hat"],		// RHS
	
	// RHS Helmets Green (gref)
	["M1 Bare", "rhsgref_helmet_M1_bare", 50, "hat"],		// RHS
	["M1 Painted", "rhsgref_helmet_M1_bare", 50, "hat"],		// RHS
	["PASGT Tri Color Desert", "rhsgref_helmet_pasgt_3color_desert_rhino", 50, "hat"],		// RHS
	["PASGT Altis Lizard", "rhsgref_helmet_pasgt_altis_lizard", 50, "hat"],		// RHS
	["PASGT ERDL Rhino", "rhsgref_helmet_pasgt_erdl_rhino", 50, "hat"],		// RHS
	["PASGT FleckTarn", "rhsgref_helmet_pasgt_flecktarn", 50, "hat"],		// RHS
	["PASGT OD", "rhsgref_helmet_pasgt_olive", 50, "hat"],		// RHS
	["PASGT Woodland", "rhsgref_helmet_pasgt_woodland_rhino", 50, "hat"],		// RHS
	["SSH-68 EMR", "rhsgref_ssh68_emr", 50, "hat"],		// RHS
	["SSH-68 VSR", "rhsgref_ssh68_vsr", 50, "hat"],		// RHS
	["SSH-68 TTsKO DIGI", "rhsgref_ssh68_ttsko_digi", 50, "hat"],		// RHS
	["SSH-68 TTsKO Forest", "rhsgref_ssh68_ttsko_forest", 50, "hat"],		// RHS
	["SSH-68 TTsKO Mountain", "rhsgref_ssh68_ttsko_mountain", 50, "hat"],		// RHS
	["SSH-68 TTsKO Dark", "rhsgref_ssh68_ttsko_dark", 50, "hat"],		// RHS
	...
	["CrewChief Helmet Black", "rhsusf_hgu56p_mask_black", 50, "hat"],			// RHS
	["CrewChief Helmet OD", "rhsusf_hgu56p_mask_green", 50, "hat"],			// RHS
	["CrewChief Skull Shield", "rhsusf_hgu56p_mask_black_skull", 50, "hat"],			// RHS
	["Jet Pilot AMERICA", "rhsusf_hgu56p_visor_usa", 50, "hat"],			// RHS
	["Jet Pilot w/ Visor", "rhsusf_hgu56p_visor", 50, "hat"],			// RHS
	["Jet Pilot w/ Mask", "rhsusf_hgu56p_visor_mask", 50, "hat"],			// RHS
	...
	// RHS Boonie Hat
	["M81 Boonie Hat", "rhs_Booniehat_m81", 10, "hat"],
	["MARPAT Desert Boonie", "rhs_booniehat2_marpatd", 10, "hat"],
	["MARPAT Woodland Boonie", "rhs_booniehat2_marpatwd", 10, "hat"],
	["MARPAT Woodland Boonie", "rhs_booniehat2_marpatwd", 10, "hat"],
	["OCP Boonie Hat", "rhs_Booniehat_ocp", 10, "hat"],
	["UCP Boonie Hat", "rhs_Booniehat_ucp", 10, "hat"],
	["DIGI Boonie Hat", "rhssaf_booniehat_digital", 10, "hat"],
	["MD2 Boonie Hat", "rhssaf_booniehat_md2camo", 10, "hat"],
	["Woodland Boonie Hat", "rhssaf_booniehat_woodland", 10, "hat"],
...
[
	...
	// RHS Blue
	["G3 Uniform Black", "rhs_uniform_g3_blk", 25, "uni"],			// RHS
	["G3 Uniform M81", "rhs_uniform_g3_m81", 25, "uni"],			// RHS
	["G3 Uniform Multi", "rhs_uniform_g3_mc", 25, "uni"],			// RHS
	["G3 Uniform Ranger", "rhs_uniform_g3_rgr", 25, "uni"],			// RHS
	["G3 Uniform Tan", "rhs_uniform_g3_tan", 25, "uni"],			// RHS
	["UCP", "rhs_uniform_cu_ucp", 25, "uni"],			// RHS
	["OCP", "rhs_uniform_cu_ocp", 25, "uni"],			// RHS
	["Jungle", "rhsgref_uniform_ERDL", 25, "uni"],			// RHS
	["FrogMan Desert", "rhs_uniform_FROG01_d", 25, "uni"],			// RHS
	["FrogMan Woodland", "rhs_uniform_FROG01_wd", 25, "uni"],			// RHS
	
	// RHS Red
	["Gorka", "rhs_uniform_gorka_r_g", 25, "uni"],			// RHS
	["Dessert", "rhs_uniform_emr_des_patchless", 25, "uni"],			// RHS
	["Summer DIGI", "rhs_uniform_emr_patchless", 25, "uni"],			// RHS
	["Flora", "rhs_uniform_flora_patchless", 25, "uni"],			// RHS
	["Gorka Tan", "rhs_uniform_gorka_r_y", 25, "uni"],			// RHS
	["M88 Tan", "rhs_uniform_m88_patchless", 25, "uni"],			// RHS
	["Mountain Flora", "rhs_uniform_mflora_patchless", 25, "uni"],			// RHS
	
	// RHS Brown (SAF)
	["M10 DIGI Desert", "rhssaf_uniform_m10_digital_desert", 25, "uni"],			// RHS
	["M10 DIGI", "rhssaf_uniform_m10_digital_tan_boots", 25, "uni"],			// RHS
	
	// RHS Green (Gref)
	["Tri Color Desert", "rhsgref_uniform_3color_desert", 25, "uni"],			// RHS
	["TTsKO Mountain", "rhsgref_uniform_ttsko_mountain", 25, "uni"],			// RHS
	["AlpenFlage Camo", "rhsgref_uniform_alpenflage", 25, "uni"],			// RHS
	["Woodland", "rhsgref_uniform_woodland", 25, "uni"],			// RHS
	["TigerStripe", "rhsgref_uniform_tigerstripe", 25, "uni"],			// RHS
	["Specter", "rhsgref_uniform_specter", 25, "uni"]			// RHS
];
...
[
	...
	// RHS
	["6SH92", "rhs_6sh92", -1, "vest"],
	["6SH92 DIGI", "rhs_6sh92_digi", -1, "vest"],
	["6SH92 VSR", "rhs_6sh92_vsr", -1, "vest"],
	["6SH92 Flora", "rhs_6b13_Flora_6sh92", -1, "vest"],
	["6SH92 OD", "rhs_6b23_6sh116_od", -1, "vest"],
	["6Sh92 ML", "rhs_6b23_ML_6sh92", -1, "vest"],
	["Rifleman Khaki", "rhsgref_6b23_khaki_rifleman", -1, "vest"],
	["Rifleman Mountain", "rhsgref_6b23_ttsko_mountain_rifleman", -1, "vest"],
	["Rifleman DIGI", "rhsgref_6b23_ttsko_digi_rifleman", -1, "vest"],
	["ALICE WebGear", "rhsgref_alice_webbing", -1, "vest"],
	["OTV DIGI", "rhsgref_otv_digi", -1, "vest"],
	["Rifleman OCP", "rhsusf_iotv_ocp_Rifleman", -1, "vest"],
	["Rifleman UCP", "rhsusf_iotv_ucp_Rifleman", -1, "vest"],
	["MBAV", "rhsusf_mbav", -1, "vest"],
	["MBAV Rifleman", "rhsusf_mbav_rifleman", -1, "vest"],
	["MBAV Machine Gunner", "rhsusf_mbav_mg", -1, "vest"],
	["MBAV Squad Leader", "rhsusf_spc_squadleader", -1, "vest"],
	["SpecOps OCP", "rhsusf_spcs_ocp_rifleman", -1, "vest"],
	["SpecOps UCP", "rhsusf_spcs_ucp_rifleman", -1, "vest"],
	["OTV Rig", "rhssaf_vest_otv_md2camo", -1, "vest"],
	...
	["MD12 DIGI", "rhssaf_vest_md12_digital", -1, "vest"],
	["MD12 DIGI Desert", "rhssaf_vest_md12_digital_desert", -1, "vest"],
...
[
	...
	// RHS
	["Eagle Coyote", "rhsusf_assault_eagleaiii_coy", 5000, "backpack"],
	["Eagle Multi", "rhsusf_assault_eagleaiii_ocp", 5000, "backpack"],
	["Eagle Digi", "rhsusf_assault_eagleaiii_ucp", 5000, "backpack"],
	["USF BackPack", "B_rhsusf_B_BACKPACK", 5000, "backpack"],
	["Falconii", "rhsusf_falconii", 5000, "backpack"],
	["Falconii Coy", "rhsusf_falconii_coy", 5000, "backpack"],
	["Falconii MC", "rhsusf_falconii_mc", 5000, "backpack"],
	["KitBag DIGI", "rhssaf_kitbag_digital", 5000, "backpack"],
	["KitBag MD-2", "rhssaf_kitbag_md2camo", 5000, "backpack"],
	["KitBag SMB", "rhssaf_kitbag_smb", 5000, "backpack"],
	["UMBTS", "rhs_assault_umbts", 5000, "backpack"],
	["UMBTS Engineer", "rhs_assault_umbts_engineer_empty", 5000, "backpack"],
	["Russian Green", "rhs_assault_umbts", 5000, "backpack"],
	["ALICE Pack", "rhssaf_alice_md2camo", 5000, "backpack"],
	["HID ALICE Pack", "rhsgref_hidf_alicepack", 5000, "backpack"],
	["TTsKO ALICE Pack", "rhsgref_ttsko_alicepack", 5000, "backpack"],
	["Woodland ALICE Pack", "rhsgref_wdl_alicepack", 5000, "backpack"],
	["MD-2 ALICE Pack", "rhssaf_alice_md2camo", 5000, "backpack"],
	["SMB ALICE Pack", "rhssaf_alice_smb", 5000, "backpack"],
...
[
	...
	["Leupold Spotting Scope", "Leupold_Mk4", 100, "binoc"],		// RHS
	["Rangefinder", "Rangefinder", 1500, "binoc"],		// RHS
	["Lerca 1200 Tan", "lerca_1200_tan", 1500, "binoc"],		// RHS
...
[
	...
	["Airport Tower", "Land_Airport_Tower_F", 300000, "object"],  // ADD
	["Cargo HQ", "Land_Cargo_HQ_V1_F", 250000, "object"],  // ADD
	["LightHouse", "Land_LightHouse_F", 300000, "object"],  // ADD
	...
	["Taru Cargo Pod", "Land_Pod_Heli_Transport_04_Box_F", 7500, "object"],		// ADD
	...
	["Sandbag Corner", "land_bagfence_corner_F", 500, "object"],		// ADD
	["Sandbag Long", "land_bagfence_long_F", 750, "object"],		// ADD
	...
	["Razorwire", "Land_Razorwire_F", 5000, "object"],			// ADD
	...
	["Military Cargo Post", "Land_Cargo_Patrol_V1_F", 8000, "object"],		// ADD
	["Military Cargo Tower", "Land_Cargo_Tower_V1_F", 100000, "object"],		// ADD
	["Concrete Ramp", "Land_RampConcrete_F", 3500, "object"],
	["Concrete Ramp (High)", "Land_RampConcreteHigh_F", 5000, "object"],
	["Concrete Stairs", "land_gh_stairs_f", 750, "object"],		// ADD
...
[
	...
	["Typhoon AFV", "rhs_typhoon_vdv", 6000, "vehicle"],
	["HEMTT Cargo", "B_Truck_01_box_F", 6000, "vehicle"],
	["HEMTT Supply", "rhsusf_M977A4_REPAIR_usarmy_d", 6000, "vehicle"],
	["HEMTT Fuel", "rhsusf_M978A4_usarmy_d", 6000, "vehicle"]
...
[
	...
	["POLARIS MRZR", "rhsusf_mrzr4_d", 6000, "vehicle"],		// RHS

	["UAZ", "RHS_UAZ_MSV_01", 6000, "vehicle"],		// RHS
	["HUMVEE", "rhsusf_m1025_w", 20000, "vehicle"],		// RHS
	["GAZ Tigr", "rhs_tigr_m_vdv", 20000, "vehicle"],		// RHS
	["RG-33", "rhsusf_rg33_usmc_d", 30000, "vehicle"],		// RHS
	["M1078 4x4 2.5 Ton", "rhsusf_M1078A1P2_B_WD_CP_fmtv_usarmy", 30000, "vehicle"],		// RHS
	...
	["M-1117 ASV", "rhsusf_M1117_D", 200000, "vehicle"],		// RHS
	["BTR-70", "rhs_btr70_vmf", 150000, "vehicle"],		// RHS
	["BTR-80", "rhs_btr80_msv", 200000, "vehicle"],		// RHS
	["M113 APC", "rhsusf_m113_usarmy", 150000, "vehicle"],		// RHS
	...
	["Russian BMD-1PK", "rhs_bmd1pk", 250000, "vehicle"],		// RHS
	["BMP-3", "rhs_bmp3_late_msv", 300000, "vehicle"]		// RHS
];
...
[
	...
	["BRM-1k", "rhs_brm1k_vdv", 325000, "vehicle"],		// RHS
	["M2A2 Bradley", "RHS_M2A2", 375000, "vehicle"],		// RHS
	["M2A3 Bradley", "RHS_M2A3", 400000, "vehicle"],		// RHS
	["Shilka ZSU-23", "rhs_zsu234_aa", 375000, "vehicle"],		// RHS
	// ["BTR-K Kamysh", "O_APC_Tracked_02_cannon_F", 400000, "vehicle"],
	["AWC 301 Nyx AT", "I_LT_01_AT_F", 400000, "vehicle"],		// Tanks DLC
	["AWC 303 Nyx AutoCannon", "I_LT_01_cannon_F", 450000, "vehicle"],		// Tanks DLC
	["AWC 302 Nyx AA", "I_LT_01_AA_F", 400000, "vehicle"],		// Tanks DLC
	// ["IFV-6a Cheetah AA", "B_APC_Tracked_01_AA_F", 400000, "vehicle"],
	// ["ZSU-39 Tigris AA", "O_APC_Tracked_02_AA_F", 400000, "vehicle"],
	["M1A1 Abrams", "rhsusf_m1a1aimwd_usarmy", 500000, "vehicle"],		// RHS
	["T-72 B3", "rhs_t72bd_tv", 500000, "vehicle"],		// RHS
	["T-90 TV", "rhs_t90a_tv", 550000, "vehicle"],		// RHS
	...
	["M-109 Howitzer", "rhsusf_m109_usarmy", 500000, "vehicle"]		// RHS
];
...
[
	...
	["MH-6M", "RHS_MELB_MH6M", 5000, "vehicle"],		// RHS
	...
	["Kamov Ka-60", "rhs_ka60_grey", 7000, "vehicle"],		// RHS
	["Russian Mi-24", "RHS_Mi24Vt_vvs", 7000, "vehicle"],		// RHS
