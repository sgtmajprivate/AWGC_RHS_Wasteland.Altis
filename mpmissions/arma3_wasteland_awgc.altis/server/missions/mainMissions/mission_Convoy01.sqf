...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted by armed vehicles from Tonos Bay to KAVALA. Stop them!", _vehicleName, mainMissionColor];
