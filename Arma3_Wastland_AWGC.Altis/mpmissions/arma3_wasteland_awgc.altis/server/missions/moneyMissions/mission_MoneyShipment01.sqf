...
_setupVars =
{
	_locationsArray = LandConvoyPath01;
...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy transporting <t color='%1'>%2</t> escorted by a <t color='%1'>%3</t> is en route from Tonos Bay to KAVALA.<br/>Find them, and Stop them!", moneyMissionColor, _moneyText, _vehicleName];
