...
_setupVars =
{
	_locationsArray = LandConvoyPath02;
...
_setupObjects =
{
	...
	_missionHintText = format ["A convoy transporting <t color='%1'>%2</t> escorted by a <t color='%1'>%3</t> is en route from North of PAROS to FERES<br/>Stop them!", moneyMissionColor, _moneyText, _vehicleName];
