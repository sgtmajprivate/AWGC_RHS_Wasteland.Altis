...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted from Tonos Bay to KAVALA. Stop the convoy!", _vehicleName, sideMissionColor];
