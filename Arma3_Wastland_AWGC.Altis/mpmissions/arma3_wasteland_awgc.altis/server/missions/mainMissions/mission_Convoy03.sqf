...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted by armed vehicles from OREOKASTRO to STFAKA. Stop them!", _vehicleName, mainMissionColor];
