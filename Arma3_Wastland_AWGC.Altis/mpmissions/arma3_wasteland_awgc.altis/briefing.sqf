...
<br/>A. The server has a day/night cycle just like in the real world, and as such, night time is a factor in your survival. You will spawn with a pistol attached flash light, default key L to turn on. Night vision can be found in areas with buildings and vehicles scattered across the map, or purchased at the GS.
<br/>
